...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabForm">
  ...
  <tr>
  <td colspan="2">
<form name="form1" method="post" action="sysUserGroupAction_list.do" namespace="/sys">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" name="base" id="base">
		<tr>
			...
			<button type='button' class='button' onMouseOver="this.className='button_over';" 
			       ...
			       <img src="${pageContext.request.contextPath}/ui/images/button/sousuo.png" style="border:0 align:absmiddle">&nbsp;搜索</button>
			<button type='button' class='button' onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  
			        ...
			        <img src="${pageContext.request.contextPath}/ui/images/button/qingkong.png" style="border:0 align:absmiddle">&nbsp;清空</button>
			</div>
			</td>
		</tr>
	</table>
...
<div class="control">
	...
	<button type='button' class='button' onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  
	        ...
	        <img src="${pageContext.request.contextPath}/ui/images/button/xinjian.png" style="border:0 align:absmiddle">&nbsp;新建</button>


	<button type='button' class='button' onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  
	        onClick="document.forms[1].submit();">
	        <img src="${pageContext.request.contextPath}/ui/images/button/shanchu.png" style="border:0 align:absmiddle">&nbsp;删除</button>

</div>
<!-- list -->
<div class="border">

<form name="form2" method="post" action="sys/sysUserGroupAction_delete.do" namespace="/sys">
