...
<body>
<form name="ActionForm" method="post" action="updateMenuPrivilege">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#6A82A8">
	<tr>
		<td align="center" height="25"><span style="color:#FFFFFF; font-weight:bold">操作权限组：<s:property value="${sysRole.name}"/></span></td>
	</tr>
</table>
			      ...
			      <fieldset style='padding:5px;clear:left;'>
			            ...
			            <c:if test="${! empty sysMenuPrivileges}">
				             <c:forEach items="${sysMenuPrivileges}" var="sysMenuPrivilege">
				                  <c:if test="${sysMenu.sysMenuKey.menuModule==sysMenuPrivilege.sysMenuKey.menuModule
				                                &&sysMenu.sysMenuKey.menuPrivilege==sysMenuPrivilege.sysMenuKey.menuPrivilege}">
					      ...
					      <legend><input type='checkbox' class='checkbox' name='menuModule'  ${xx}
					           value='${sysMenu.sysMenuKey.menuModule},${sysMenu.sysMenuKey.menuPrivilege}' 
					           id='${sysMenu.sysMenuKey.menuModule}_${sysMenu.sysMenuKey.menuPrivilege}'
						     ...
						     <c:if test="${sysMenuSub.sysMenuKey.menuModule!=sysMenuSub.sysMenuKey.menuPrivilege
					            ...
					            <c:if test="${! empty sysMenuPrivileges}">
						             <c:forEach items="${sysMenuPrivileges}" var="sysMenuPrivilegexx">
						                  <c:if test="${sysMenuSub.sysMenuKey.menuModule==sysMenuPrivilegexx.sysMenuKey.menuModule
						                                &&sysMenuSub.sysMenuKey.menuPrivilege==sysMenuPrivilegexx.sysMenuKey.menuPrivilege}">
						         ...
						         <div><input type='checkbox' class='checkbox' name='menuModule'   ${xxx}
						               value='${sysMenuSub.sysMenuKey.menuModule},${sysMenuSub.sysMenuKey.menuPrivilege}' 
						               id='${sysMenuSub.sysMenuKey.menuModule}_${sysMenuSub.sysMenuKey.menuPrivilege}'
