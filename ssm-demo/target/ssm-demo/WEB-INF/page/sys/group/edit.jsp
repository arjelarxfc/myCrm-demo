  	...
  	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td><input name="name" value="${group.name}" type="text" style="width:90%"/></td>
				<td>部门负责人</td>
				<td><input name="principal" value="${group.principal}" type="text" style="width:90%"/></td>
			</tr>
			<tr>
				<td height="40" valign="top">部门职能</td>
				<td colspan="3"><input name="incumbent" value="${group.incumbent}" type="text" rows="3" style="width:96%"></td>
			</tr>
			<tr>
				<td height="40" valign="top">备注</td>
				<td colspan="3"><input name="remark" id="remark" type="text" value="${group.remark}" rows="3" style="width:96%"></td>
			</tr>
  		</table>
		</div>
	</td>
