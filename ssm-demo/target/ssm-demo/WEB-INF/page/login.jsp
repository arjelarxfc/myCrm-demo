...
<form name="form1" method="post" action="sys/sysUserLogin">
...
<TR>
	...
	<TR>
		<TD valign="top" align="center"><img src="${pageContext.request.contextPath}/ui/images/musiclogo.jpg">
		</TD>
		<TD width="44" height="200" background="${pageContext.request.contextPath}/ui/images/line.png">&nbsp;</TD>
		<TD width="540" valign="top">
		  <TABLE style="width:100%;margin-top:60px;"  cellpadding="0" cellspacing="0">
		  <TR>
			  ...
			  <TR>
			  	...
			  	<input name="name" type="text" value="<%= name %>" id="name"/></TD>
			  </TR>
			  <TR>
			  	<TD class="td">登录密码：</TD>
...
<TR>
	<TD align="center"><br><a href="#" target="_blank">秦熠科技有限公司</a></TD>
</TR>
<TR>
	<TD height="5">&nbsp;</TD>
</TR>
