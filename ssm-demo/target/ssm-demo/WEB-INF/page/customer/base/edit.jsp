  	...
  	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
			...
			<td width="34%"><input type="text" id="code" name="code"  style="width:90%"/></td>
			<td width="16%" class="red">客户名称：</td>
			<td width="34%"> 
			  <input type="text" id="name" name="name" style="width:90%"  onblur="name2pinyin()"/>
			</td>
		  </tr>
		  <tr>
			<td>拼音码：</td>
			<td> 
			  <input type="text" id="pycode" name="pycode"  style="width:90%" readonly="readonly" class="disabled"/>
			</td>
			<td>客户等级：</td>
			<td>
		   ...
		   <tr>
			<td>区域名称：</td>
			<td>
			     <c:if test="${regionNamesSelect!=null}">
		  ...
		  <tr>
			<td>省份：</td>
			<td>
			  <c:if test="${provincesSelect!=null}">
		  ...
		  <tr>
			<td>联系地址：</td>
			<td colspan="3">
			   <input type="text" name="address" id="address"  style="width:96%"/>
			</td>
			</tr>
		  <tr>
			<td>电子邮件：</td>
		  ...
		  <tr>
			<td>电话一：</td>
			<td><input type="text" name="tel1" id="tel1"  style="width:90%"  /></td>
			<td>传真：</td>
			<td><input type="text" name="fax" id="fax"  style="width:90%"  /></td>
		  </tr>
		  <tr>
		  	<td>手机：</td>
			<td>
			    <input type="text" name="mobile" id="mobile" style="width:90%" />
			</td>
			<td>电话二：</td>
			<td>
		  ...
		  <tr>
			<td>下次联系时间:</td>
			<td>
			   <input type="text" name="nextTouchDate" id="nextTouchDate"  style="width:90%" class="dateClassStyle"/>
		    </td>
			<td>客户性质：</td>
  	...
  	<div id="menu2">
		...
		<tr>
		  ...
		  <tr>
			<td>法人代表：</td>
			<td>
			   <input type="text" name="artificialPerson" id="artificialPerson"  style="width:90%"/></td>
			<td>注册资金：</td>
			<td><input type="text" name="registeMoney" id="registeMoney"  style="width:90%"/></td>
		  </tr>
		  <tr>
			<td>开户银行：</td>
			<td><input type="text" name="bank" id="bank"  style="width:90%"/></td>
			<td>银行账户：</td>
			<td><input type="text" name="account" id="account"  style="width:90%"/></td>
		  </tr>
		  <tr>
			<td>公司税号：</td>
			<td><input type="text" name="taxCode" id="taxCode"  style="width:90%"/></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		  </tr>
  		</table>
  	...
  	<div id="menu3">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
			<td>所属人：</td>
			<td>
			  <s:textfield  name="dispensePerson" id="dispensePerson"  style="width:90%" class="disabled"/>
			  <!-- 保存的是所属人的id -->
