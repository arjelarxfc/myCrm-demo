 ...
 function do_share(){
	   ...
	   if(count==0){
		...
		if(count==1){  //选中一个客户的情况下
		   ...
		   OpenWin("${pageContext.request.contextPath}/crm/company/showShareSetOne?id="+ids,'',500,400)
...
<br>&nbsp;&nbsp;
	<a href="${pageContext.request.contextPath}/crm/company/list">今天需要联系的客户</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="${pageContext.request.contextPath}/crm/company/list">已过期未联系的客户</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="${pageContext.request.contextPath}/crm/company/list">全部</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabForm">
  ...
  <tr>
	  <td colspan="2">
<!-- 基本查询的表单-->
<form name="form1" method="post" action="/crm/company/list">
...
<div class="control">
	<button type='button' class='button' onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  
	     onClick="forward('${pageContext.request.contextPath}/crm/company/add')">
...
<div class="border">
<form method="post" action="crm/company/delete">
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="PowerTable" class="PowerTable">
	...
	<c:if test="${companyList!=null}">
		<c:forEach items="${companyList}"  var="company">
			<tr>
		    	<td>
		    		<input type="checkbox" name="ids" value="${company.id}" onclick="changeCheckCount();"/>
		    	</td>
		  	    <td>
		  	       <a href="${pageContext.request.contextPath}/crm/company/edit?companyId=${company.id}">${company.name}</a>
		  	    </td>
...
<script type="text/javascript">
	function goChangePerson() {
	  ...
	  var url = "${pageContext.request.contextPath}/crm/company/changePerson?ids="+ids;
    ...
    function gonextTouchTime(){
	 ...
	 OpenWin("${pageContext.request.contextPath}/crm/company/nextTouchTime?ids="+ids,'',420,300);
	}
