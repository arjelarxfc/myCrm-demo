  	...
  	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<td width="34%"><input type="text" id="code" name="code" value="${code}"  style="width:90%"/></td>
			<td width="16%" class="red">客户名称：</td>
			<td width="34%"> 
			  <input id="name" name="name" value="" style="width:90%"  onblur="name2pinyin()"/>
			</td>
		  </tr>
		  <tr>
			<td>拼音码：</td>
			<td> 
			  <input id="pycode" name="pycode" value="" style="width:90%" readonly="readonly" class="disabled"/>
			</td>
			<td>客户等级：</td>
			<td>
			   <c:if test="${gradesSelect!=null}">
		  ...
		  <tr>
			<td>邮政编码：</td>
			<td>
			  <input type="text" name="postcode" value="" id="postcode"  style="width:90%"/>
			</td>
		  </tr>
		  <tr>
			<td>联系地址：</td>
			<td colspan="3">
			   <input type="text" name="address" value="" id="address"  style="width:96%"/>
			</td>
			</tr>
		  <tr>
			<td>电子邮件：</td>
			<td>
			  <input type="text" name="email" id="email" style="width:96%"  value=""/>
			</td>
			<td>公司网站：</td>
			<td>
			   <input type="text" name="web" id="web"  style="width:90%"  value=""/>
			</td>
		  </tr>
		  <tr>
			<td>电话一：</td>
			<td><input type="text" name="tel1" id="tel1"  style="width:90%"  value=""/></td>
			<td>传真：</td>
			<td><input type="text" name="fax" id="fax" style="width:90%"  value=""/></td>
		  </tr>
		  <tr>
		  	<td>手机：</td>
			<td>
			    <input type="text" name="mobile" id="mobile"  style="width:90%"  value=""/>
			</td>
			<td>电话二：</td>
			<td>
			    <input type="text" name="tel2" id="tel2"  style="width:90%"  value=""/>
			</td>
		  </tr>
		  <tr>
			<td>下次联系时间:</td>
			<td>
			   <input type="text" name="nextTouchDate" id="nextTouchDate"  style="width:90%" class="dateClassStyle"  value=""/>
		    </td>
			<td>客户性质：</td>
		  ...
		  <tr>
			<td valign="top">备注：</td>
			<td colspan="3">
			  <input type="text" name="remark" rows="4" id="remark" style="width:96%"/>
			</td>
		  </tr>
		  </table>
		</div>
  ...
  <div id="menu2">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
			<td>法人代表：</td>
			<td>
			   <input type="text" name="artificialPerson" id="artificialPerson"  style="width:90%"  value=""/></td>
			<td>注册资金：</td>
			<td><input type="text" name="registeMoney" id="registeMoney"  style="width:90%"  value=""/></td>
		  </tr>
		  <tr>
			<td>开户银行：</td>
			<td><input type="text" name="bank" id="bank"  style="width:90%"  value=""/></td>
			<td>银行账户：</td>
			<td><input type="text" name="account" id="account"  style="width:90%"  value=""/></td>
		  </tr>
		  <tr>
			<td>公司税号：</td>
			<td><input type="text" name="taxCode" id="taxCode"  style="width:90%"  value=""/></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		  </tr>
  		</table>
  ...
  <div id="menu3">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td width="16%">创建人：</td>
			<td width="34%">
			   <input type="text" name="creater" id="creater"  style="width:90%" class="disabled" />
			</td>
			<td width="16%">创建日期：</td>
			<td width="34%">
			  <input type="text" name="createTime" id="createTime"  style="width:90%" class="disabled" />
		   </td>
		  </tr>
		  <tr>
			<td>修改人：</td>
			<td>
			   <input type="text" name="updater" id="updater"  style="width:90%" class="disabled" />
			</td>
			<td>修改日期：</td>
			<td>
			<input type="text" name="updateTime" id="updateTime"  style="width:90%"  class="disabled" />
		   </td>
		  </tr>
		  <tr>
			<td>所属人：</td>
			<td>
   			  <!-- 保存所有人的姓名 -->
   			  <input type="text" name="dispensePerson" id="dispensePerson"  style="width:90%" class="disabled"/>
			  <!-- 保存所属人的id -->
